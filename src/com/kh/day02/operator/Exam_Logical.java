...
public class Exam_Logical {
	public static void main(String [] args) {
		...
		// num1과 num2가 다르면서 mum2가 num1보다 클때
		...
		// 결과는 true
		result4 = (num1 > num2) || (num1 == num2); // 앞의 값이 트루가 나오면 뒤에 연산은 안한다.
		// 결과는 true
		...
		// false,	aNum=71,	bNum=55,	앞 연산이 false면 뒤 연산은 연산 안하고 false판정.
		result3 = (aNum != bNum) && (bNum-- < aNum++);	
		// true,	aNum=72,	bNum=54
		result4 = (aNum++ != bNum) || (bNum++ >= 85);	
		// true,	aNum=73,	bNum=54,	/앞 연산이 true면 뒤 연산은 연산하지 않고 true판정.
		// aNum : 73,	bNum : 54
		System.out.println("result1의 결과값 : " + result1);
		System.out.println("result2의 결과값 : " + result2);
		System.out.println("result3의 결과값 : " + result3);
